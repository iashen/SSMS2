...
<body id="skin-blur-violate">
    ...
    <section id="main" class="p-relative" role="main">
        ...
        <section id="content" class="container">
            ...
            <div class="block-area" id="basic">
                <h3 class="block-title">Teachers Registration Form</h3>
                <form role="form">

                    <div class="form-group">
                        <label for="exampleInputEmail1">Name</label>
                        <input type="text" class="form-control input-sm" tabindex="1" id="tname" placeholder="Enter Name">

                    </div>

                    <div class="form-group">
                        <label for="exampleInputPassword1">Class</label>
                        <input type="text" class="form-control input-sm" tabindex="2" id="tclass" placeholder="Enter Class">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-primary">                              
                            <input type="text" class="main-search" id="dev-table-filter" data-action="filter" data-filters="#teacher_data_table" placeholder="Search Delegates" />

                            <div class="table-responsive overflow">
                                <hr class="whiter m-t-20" />
                                <div style="height:300px;display:inherit">
                                    <table class="table table-hover" id="teacher_data_table">
                                        <thead>
                                            <tr>
                                                <th>First Name</th>
                                                <th>City</th>                                                      
    ...
    <script src="controllers/controller_teacher.js"></script><!-- student controller -->
