       ...
       ?>
        ...
        <section id="content" class="container">
            ...
            <div class="block-area" id="multi-column">
                <h3 class="block-title">Customer Registration Form</h3>
                <form class="row form-columned" role="form">

                    <div class="col-md-4">
                        <label>Customer Registration Number</label>
                        <input type="text" class="form-control input-sm m-b-10" placeholder="input registration ID">
                    </div>
                    
                     <div class="col-md-4">
                        <label>Full Name</label>
                        <input type="text" class="form-control input-sm m-b-10" placeholder="input full name">
                    </div>
                    
                    <div class="col-md-4">
                        <label>Pre Name</label>
                        <input type="text" class="form-control input-sm m-b-10" placeholder="input pre name">
                    </div>
                    
                    <div class="col-md-4">
                        <label>Mobile Number</label>
                        <input type="number" class="form-control input-sm m-b-10" placeholder="input mobile number">
                    </div>
                    
                     <div class="col-md-4">
                        <label>Telephone Number</label>
                        <input type="number" class="form-control input-sm m-b-10" placeholder="input telephone number">
                    </div>
                    
                    <div class="col-md-4">
                        <label>Emergency Number</label>
                        <input type="number" class="form-control input-sm m-b-10" placeholder="input mobile number for emergency calls">
                    </div>
                    
                     <div class="col-md-4">
                        <label>Address</label>
                        <input type="text" class="form-control input-sm m-b-10" placeholder="input customer address">
                    </div>
            ...
            <a data-toggle="modal" href="#modalDefault" class="btn btn-sm">Vehicle Registration</a>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div>
                                    ...
                                    <input type="text" class="form-control input-sm m-b-10" placeholder="Enter Catogory">
                                </div>
                                </div>
                ...
                -->
                    ...
                    <div class="col-md-10">
                        <button type="submit" class="btn btn-lg btn-alt m-r-5">Save Customer Info</button>
                    </div>
                </form>
            </div>
